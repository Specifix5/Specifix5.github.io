...
function start() {
    ...
    const starColor = "rgb(255, 255, 255)"
    const shootingstarColor = "rgba(255, 255, 255, "
    const shootingstarTrailColor = "rgba(255, 255, 255 "
    ...
    const gradient = context.createRadialGradient(canvas.width/2, canvas.height/2, 100, canvas.width/2, canvas.height/2, Math.max(canvas.width, canvas.height));
    gradient.addColorStop(0, "#1a2935");
    gradient.addColorStop(0.6, "#030507");
    ...
    function createShootingStar() {
        var shootingStar = particle.create(randomRange(width/3, width), randomRange(-height/4, height/3), 0, 0);
    ...
    function drawShootingStar(p) {
        ...
        context.fillStyle = shootingstarColor + p.opacity + ")";
        // context.beginPath();
        ...
        //trail
        context.fillStyle = shootingstarTrailColor + p.opacity + ")";
        context.beginPath();
        context.moveTo(x - 1, y - 1);
